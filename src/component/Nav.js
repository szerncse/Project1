    ...
    return (
        <div className="w-full bg-[#fff]">
            <div className="w-[1200px] mx-auto flex justify-between items-center">
                <div><NavLink to="/"><img className="items-center w-[200px] h-[65px]" src="./../images/logo.png" alt="logo" /></NavLink></div>
                <div className='w-[50%]'>
                ...
                <div className='w-[10%]'>
                    <ul className='flex justify-between'>
                        <li><NavLink><FontAwesomeIcon icon={faEarthAmericas} className='text-[15px]' /></NavLink></li>
                        <li><NavLink><FontAwesomeIcon icon={faCloudMoon} className='text-[15px]' /></NavLink></li>
                    </ul>
                </div>
            </div>
        </div>  
